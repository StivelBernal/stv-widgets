 ...
 *
 * @category   Class
 * @package    Elementor_Stv
 * @subpackage WordPress
 * @author     Stivel Bernal <contact@stivel.me>
 * @copyright  2020 Stivel Bernal
 * @license    https://opensource.org/licenses/GPL-3.0 GPL-3.0-only
 * @link       link(https://www.bstivel.me/elementor/,
...
final class Elementor_Stv {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-stv' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_STV ) );
